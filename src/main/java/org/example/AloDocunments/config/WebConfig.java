package org.example.AloDocunments.config;

import org.example.AloDocunments.interceptors.LoginInterceptor;
...
//      registry.addInterceptor(loginInterceptor).excludePathPatterns("/user/**");
        registry.addInterceptor(loginInterceptor).addPathPatterns("/category")
